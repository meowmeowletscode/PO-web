        ...
        >
          ...
          <div class="form-actions">
            ...
            <button
              ...
              :aria-label="isSubmitting ? 'Creating user...' : 'Create user'"
            >
          ...
          <div 
            ...
            aria-live="assertive"
          >
            <strong>Failed to create user:</strong> {{ submitError }}
            <button 
...
const handleCreateUser = async () => {
  ...
  try {
    ...
    successMessage.value = `User "${formData.username}" created successfully!`
    ...
    submitError.value = error.details || error.error || 'Failed to create user'
